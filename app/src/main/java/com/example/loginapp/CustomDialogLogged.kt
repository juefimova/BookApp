...
import com.example.loginapp.databinding.FragmentDialogLoggedBinding

class CustomDialogLogged : DialogFragment()  {
    ...
    override fun onCreateView(
        ...
        return FragmentDialogLoggedBinding.inflate(inflater, container, false)
            .also {
                it.headline.run {
                    append(textStyle)
                }
    ...
    companion object{
        ...
        fun getIstance(key: String, position: Int) = CustomDialogLogged().apply {
            Log.d(key, "key")
