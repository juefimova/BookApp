...
import com.example.loginapp.databinding.FragmentDialogError2Binding
import com.example.loginapp.databinding.FragmentDialogError3Binding
import com.example.loginapp.databinding.FragmentDialogErrorBinding

class CustomDialogError3 : DialogFragment()  {
    ...
    override fun onCreateView(
        ...
        return FragmentDialogError3Binding.inflate(inflater, container, false)
            .also {
                it.headline.run {
                    append(textStyle)
                }
